...
class RosClient():
    ...
    # def run_till_ack_from_fms(self,stop_event, msg):
    ...
    def service_call(self, service, args,service_id):
        try:
            ...
            # self.tm.start_thread(service_id,self.run_till_ack_from_fms,args=(msg,))
            # self.service_calls_thread.append(thread)
