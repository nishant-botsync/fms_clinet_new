...
class RosClient():
    ...
    def send_message(self, *args):
        try:
            ...
            logger_error_configuration("EXCEPTION IN CALLBACK: ", str(e))
    ...
    def subscribe_callback(self, msg, *args):
        ...
        fms_filtered = convert(args[0]) == "/"+self.robot_name+"/fms_scan_filtered"        
    ...
    def run_command(self, message):
        try:
            ...
            op = m.get("OP")
            print('fms_laser_client topics',m)
    ...
    def callback(self, data, time=None):
        ...
        if time:
            ...
            if (time - datetime_now).total_seconds() > 1:
                logger_error_configuration("SUBSCRIBE MESSAGE CALLBACK ERROR: Time difference is greater than 1 second")
                return None
...
def on_error(ws, error):
    logger_error_configuration(error)
...
if __name__ == '__main__':
    ...
    factory = MyClientFactory("wss://" + client_ip +":8001/ws/robot_laser_data/"+ robot_name+ "/")
